      ...
      events: [
        {
          ...
          address: 'Calle Pezuela entre Cármen y Montaña, Cojimar, Habana del Este',
          dateLabel: 'Fecha',
          timeLabel: 'Hora',
          venueLabel: 'Lugar',
          mapUrl:
        ...
        },
        {
          ...
          address: 'Calle Chacón entre Pezuela y Los Pinos, Cojimar, Habana del Este',
          dateLabel: 'Fecha',
          timeLabel: 'Hora',
          venueLabel: 'Lugar',
          mapUrl:
      ...
      events: [
        {
          ...
          time: '4:00 PM',
          venue: 'Iglesia de la Virgen del Carmen',
          address: 'Pezuela Street between Carmen and Montaña, Cojimar, Havana del Este',
          dateLabel: 'Date',
          timeLabel: 'Time',
          venueLabel: 'Venue',
          mapUrl:
        ...
        },
        {
          ...
          time: '6:00 PM',
          venue: 'La Yola, Casa de Fiestas',
          address: 'Chacón Street between Pezuela and Los Pinos, Cojimar, Havana del Este',
          dateLabel: 'Date',
          timeLabel: 'Time',
          venueLabel: 'Venue',
          mapUrl:
